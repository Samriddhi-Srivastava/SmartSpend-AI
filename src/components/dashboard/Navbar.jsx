      ...
      <header className="h-16 border-b border-line bg-ink-soft/50 dark:bg-slate-900/50 backdrop-blur sticky top-0 z-40 flex items-center justify-between px-6 transition-colors duration-300">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-3 pl-4 border-l border-line dark:border-slate-700 hover:opacity-80 transition"
          >
            ...
            <div className="w-10 h-10 rounded-full bg-sage/20 dark:bg-sage/10 border border-sage/30 dark:border-sage/20 flex items-center justify-center overflow-hidden">
              {session?.user?.image ? (
                <Image
